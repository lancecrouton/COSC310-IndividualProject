# COSC 310 Individual Project - Lance Corton 15132574
...
APIs used in this version:
Wikipedia API - Grabs the text input and puts it on the Wikipedia and grabs the title, summary text, and image URL of the Wikipedia site.
This is used for users to search the meaning for their specific mental illness when they ask for "Other" mental illness such as "ADHD".

Google Translate API - Translates a given text from one language to another language.
I used the Google Translate API with the Wikipedia API where the user has the choice to change the language of the given Wikipedia information into a language that they would prefer.
